...
class LocationButton(RecycleView):
	location=ListProperty()
	

class CustomRecycleView(RecycleView):
    pass  # You can extend functionality here if needed
...
class AddLocationForm(BoxLayout):
    ...
    def search_location(self):
        ...
        results = [('Location 1', 'US'), ('Location 2', 'US')]
        
        # Populate the RecycleView data
        self.search_results.data = [{'location': loc} for loc in results]
